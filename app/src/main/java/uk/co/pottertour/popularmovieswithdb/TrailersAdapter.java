...
public class TrailersAdapter extends RecyclerView.Adapter<TrailersAdapter.DetailsAdapterViewHolder> {
     ...
     */
    public TrailersAdapter(@NonNull Context context, DetailsAdapterOnClickHandler clickHandler) {
        mContext = context;
...
//            mFavourite = (ToggleButton) view.findViewById(R.id.button_favourite);
        ...
        public void onClick(View view) {
            ...
            String trailerUrlStr = null;
            //Log.i(TAG, "!!!!!!onClick - look at this trailers JsonObject: " + mTrailersList.get(adapterPosition));
            trailerUrlStr = mTrailersList.get(adapterPosition);

            Log.v(TAG, "sending URL str to DetailActivity: " + trailerUrlStr);
...
//                break;
            case VIEW_TYPE_LIST_ITEM:
                ...
                detailsAdapterViewHolder.mLinkTV.setText("Trailer " + (position + 1));
...
//        }
    ...
    public int getItemCount() {
        ...
        Log.wtf(TAG, "getItemCount: we have " + (mTrailersList.size()) + " trailers\n" + mTrailersList);
        return mTrailersList.size(); //size();
     ...
     */
    public void setMoviesData(ArrayList<String> trailersList) {//List<String> trailersList) {
        Log.v(TAG, "setMoviesData, db list = " + trailersList);
