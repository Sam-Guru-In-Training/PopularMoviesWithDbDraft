...
public class MoviesContract {
     ...
     * Play Store.
     */
    public static final String CONTENT_AUTHORITY = "uk.co.pottertour.popularmovieswithdb";
    ...
    public static final class MoviesEntry implements BaseColumns {
        ...
        /*
        A movie object has these fields
        ...
        And then we need to be able to add trailers and reviews when a user clicks into MovieDetail
        */
        ...
        /**
         * Builds a URI that adds the _ID to the end of the content URI path.
         * This is used to query details about a single movie by _id. This is what we
         * use for the detail view query.
         *
         * @param rowId is the db _ID of a single record, NOT the movieId from the API
         * @return Uri to query details about
         */
        public static Uri buildMovieUriWithRowId(long rowId) {
...
//            return MoviesContract.MoviesEntry.COLUMN_TITLE + " >= " + normalizedUtcNow;
//        }
    }
}